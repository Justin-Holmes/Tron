...
Game.prototype.createPlayers = function() {
  this.playerOne = new Player("#14CDE8", { x: 10, y: 25 }, "right", this.oneKeys);
  this.playerTwo = new Player("#E2AA13", { x: 90, y: 25 }, "left", this.twoKeys);
};
...
Game.prototype.borderCollision = function(position) {
  return position.x == -1 || position.x == 1000 / 10 || position.y == -1 || position.y == 500 / 10
};
