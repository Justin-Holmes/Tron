$(document).ready(function(){
  ...
  function playerOneKeys(key) {
    if(key == "65" && playerOne.direction != "right")
      playerOne.direction = "left";
    else if(key == "87" && playerOne.direction != "down")
      playerOne.direction = "up";
    else if(key == "68" && playerOne.direction != "left")
      playerOne.direction = "right";
    else if(key == "83" && playerOne.direction != "up")
      playerOne.direction = "down";
  }

  function playerTwoKeys(key) {
    if(key == "37" && playerTwo.direction != "right")
      playerTwo.direction = "left";
    else if(key == "38" && playerTwo.direction != "down")
      playerTwo.direction = "up";
    else if(key == "39" && playerTwo.direction != "left")
      playerTwo.direction = "right";
    else if(key == "40" && playerTwo.direction != "up")
